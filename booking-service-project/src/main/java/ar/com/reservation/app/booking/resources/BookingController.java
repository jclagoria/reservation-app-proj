package ar.com.reservation.app.booking.resources;
...
import ar.com.reservation.app.booking.domain.service.BookingService;
import ar.com.reservation.app.booking.domain.valueobject.BookingVO;
...
public class BookingController {
    ...
    public ResponseEntity<Booking> add(@RequestBody BookingVO bookingVO) {
        logger.info(String.format("booking-service add() invoked: %s for %s",
