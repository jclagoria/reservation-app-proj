...
public class RestaurantControllerIntegrationTests
        extends AbstractRestaurantControllerTests {
    ...
    public void testGetById_NoContent() {
        ...
        ResponseEntity<Map> responseE = restTemplate
                .exchange("http://localhost:" + port + "/v1/restaurants/99", HttpMethod.GET, entity, Map.class);
    ...
    public void testGetByName() {
        ...
        ResponseEntity<Map[]> responseE = restTemplate
                .exchange("http://localhost:" + port + "/v1/restaurants?name={name}",
